...
export async function RootView() {
	return /* HTML */ `
		<!-- Titre FT_transcendance en haut -->
		<div class="bg-gray-100 py-2">
			<h1 id="dash-main-title" class="text-center text-4xl font-bold text-black">
				FT<span class="text-blue-600">_</span>transcendance
			</h1>
		</div>
	...
	return /* HTML */ `
		...
		<div class="bg-gray-100 py-2">
			<a href="/dashboard" class="block text-center text-4xl font-bold text-black cursor-pointer">
				<h1 id="dash-main-title">FT<span class="text-blue-600">_</span>transcendance</h1>
			</a>
		</div>
...
export async function RegisterView() {
	return /* HTML */ `
		<!-- Titre FT_transcendance en haut -->
		<div class="bg-gray-100 py-2">
			<h1 class="text-center text-4xl font-bold text-black mb-8">FT<span class="text-blue-600">_</span>transcendance</h1>
		</div>
		<!-- Arrière-plan -->
